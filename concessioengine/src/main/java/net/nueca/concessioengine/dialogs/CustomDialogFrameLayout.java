 ...
 */
    ...
    public CustomDialogFrameLayout(Context context, final List<String> moduleName) {
        super(context);
        ...
        customModuleAdapter = new CustomModuleAdapter(R.layout.item_module, mModuleName);
