 ...
 */
public class SalesWeek1 extends SimpleWeekSalesFragment  {
    public static SalesWeek1 instance = null;
    private String TAG = "SalesWeek1";

    public static SalesWeek1 getInstance() {
        if(instance == null) {
            return new SalesWeek1();
        }
        return instance;
    }
    ...
    public String getWeekTitle() {
        return getResources().getString(R.string.weekly_title_1);
    }
    ...
    private void generateValues() {
        setDateComparing1(DateTools.getDatesOfThisWeek());
        setDateComparing2(DateTools.getDatesOfLastWeek());
    }

    @Override
    public void isRefreshing(SwipeRefreshLayout swipeRefreshLayout) {
        super.isRefreshing(swipeRefreshLayout);
        getSalesRefreshListener().onRefresh(Update.WEEK, UpdateWeekType.THIS_WEEK, swipeRefreshLayout);
    }

    @Override
    public void onStop(){
        super.onStop();
        getSalesRefreshListener().onPageStopped(SyncDailySales.REQUEST_TAG_WEEKLY1);
