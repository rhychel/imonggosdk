 ...
 */
public class SalesWeek2 extends SimpleWeekSalesFragment {
    public static SalesWeek2 instance = null;
    private String TAG = "SalesWeek2";

    public static SalesWeek2 getInstance() {
        if (instance == null) {
            return new SalesWeek2();
        }
        return instance;
    }
    ...
    public String getWeekTitle() {
        return getResources().getString(R.string.weekly_title_2);
    }
    ...
    private void generateValues() {
        setDateComparing1(DateTools.getDatesOfLastWeek());
        setDateComparing2(DateTools.getDatesOfLast2Weeks());
    }

    @Override
    public void isRefreshing(SwipeRefreshLayout swipeRefreshLayout) {
        super.isRefreshing(swipeRefreshLayout);
        getSalesRefreshListener().onRefresh(Update.WEEK, UpdateWeekType.LAST_WEEK, swipeRefreshLayout);
    }
    ...
    public void onStop(){
        super.onStop();
        getSalesRefreshListener().onPageStopped(SyncDailySales.REQUEST_TAG_WEEKLY2);
    }
}
