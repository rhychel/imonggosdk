...
public class Customer extends BaseTable3 implements Extras.DoOperationsForExtras {
    ...
    public enum CustomerFields {
        ...
        FIRST_NAME("first_name", InputType.TYPE_TEXT_VARIATION_PERSON_NAME | InputType.TYPE_TEXT_FLAG_CAP_SENTENCES),
        MIDDLE_NAME("middle_name", InputType.TYPE_TEXT_VARIATION_PERSON_NAME | InputType.TYPE_TEXT_FLAG_CAP_SENTENCES),
        LAST_NAME("last_name", InputType.TYPE_TEXT_VARIATION_PERSON_NAME | InputType.TYPE_TEXT_FLAG_CAP_SENTENCES),
