 ...
 */
public abstract class BaseTransactionTable3 extends BaseTable3 implements Extras.DoOperationsForExtras {
    @Expose
    @DatabaseField
    ...
    public BaseTransactionTable3() {}

    public BaseTransactionTable3(Builder builder) {
    ...
    protected static class Builder <T extends Builder> {
        ...
        public <T extends BaseTransactionTable3> T build() throws NoSuchMethodException {
